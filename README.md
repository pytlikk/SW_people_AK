...
| Animal health and feeding anomalies | FR#2I | [ADR-022](./adrs/ADR-022-detect-welfare-anomalies-against-per-subject-baselines.md), [targeted AI view](./diagrams/ai-animal-health-anomaly.md), [6 golden cases](./evals/animal-health-anomaly/). Event-storming Board A (AC-01..AC-05) reconstructed and aligned to ADR-020..022. |
| Jumping-piranha population | FR#2J | [ADR-023](./adrs/ADR-023-anchor-piranha-population-on-human-census.md), [targeted AI view](./diagrams/ai-piranha-population.md), [5 golden cases](./evals/piranha-population/). Event-storming Board A (AC-04) reconstructed and aligned to ADR-020/023. |
| Ride predictive maintenance | FR#2K | Not yet - and **no workstream owns it**. Not an explicit requirement in the brief. Event-storming Board B (IO-03) names the component; no ADR. |
| Ops copilot | FR#2L | Not yet. Event-storming Boards A (AC-05) and B (IO-08) name the component; one service or two is an open question. |
...
- **No style, no characteristics funnel, no C1.** Event storming exists for all five boards (see [event-storming/](./event-storming/event_storming.md)); the derivation chain stops before characteristics. C4 container and component views exist for animal care only; there is no system context view and no diagram for ticketing or the intranet.
